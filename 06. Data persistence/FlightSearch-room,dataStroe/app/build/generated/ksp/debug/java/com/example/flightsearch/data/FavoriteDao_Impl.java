...
public final class FavoriteDao_Impl implements FavoriteDao {
  ...
  @Override
  public Object favoriteAirportRouteInsert(final Favorite favoriteAirport,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfFavorite.insert(favoriteAirport);
  ...
  @Override
  public Object favoriteAirportRouteDelete(final Favorite favoriteAirport,
      final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfFavorite.handle(favoriteAirport);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Flow<List<Favorite>> getAllFavorite() {
