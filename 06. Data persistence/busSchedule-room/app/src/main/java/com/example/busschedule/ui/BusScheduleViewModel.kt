...
class BusScheduleViewModel(private val busScheduleDao: BusScheduleDao) : ViewModel() {
    ...
    companion object {
        val factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                val application: BusScheduleApplication =
                    (this[APPLICATION_KEY] as BusScheduleApplication)
                BusScheduleViewModel(busScheduleDao = application.database.busScheduleDao())
            }
        }
    }
}
