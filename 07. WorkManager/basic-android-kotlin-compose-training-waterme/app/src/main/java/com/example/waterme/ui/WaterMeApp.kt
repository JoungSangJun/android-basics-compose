...
import com.example.waterme.FIVE_MINUTE
import com.example.waterme.ONE_MINUTE
import com.example.waterme.TEN_MINUTE
...
fun ReminderDialogContent(
    ...
    val reminders = listOf(
        ...
        Reminder(R.string.one_day, ONE_MINUTE, TimeUnit.MINUTES, plantName),
        Reminder(R.string.one_week, FIVE_MINUTE, TimeUnit.MINUTES, plantName),
        Reminder(R.string.one_month, TEN_MINUTE, TimeUnit.MINUTES, plantName)
    )
